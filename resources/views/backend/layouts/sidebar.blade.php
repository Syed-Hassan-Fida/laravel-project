                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="fas fa-cart-plus"></i><span>Cart</span> </a>
                                <ul>
                                    <li><a href="departments.html">All Departments</a></li>
                                    <li><a href="add-departments.html">Add Departments</a></li>
                                </ul>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Post Category</span> </a>
                                <ul>
                                    <li><a href="departments.html">All Departments</a></li>
                                    <li><a href="add-departments.html">Add Departments</a></li>
                                </ul>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-users"></i><span>Post Tags</span> </a>
                                <ul>
                                    <li><a href="departments.html">All Departments</a></li>
                                    <li><a href="add-departments.html">Add Departments</a></li>
                                </ul>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Post Management</span> </a>
                                <ul>
                                    <li><a href="departments.html">All Departments</a></li>
                                    <li><a href="add-departments.html">Add Departments</a></li>
                                </ul>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Review Management</span> </a>
                                <ul>
                                    <li><a href="departments.html">All Departments</a></li>
                                    <li><a href="add-departments.html">Add Departments</a></li>
                                </ul>
                            ...
                            <li><a href="#"><i class="icon-settings"></i><span>Settings</span> </a>
